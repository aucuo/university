...
namespace Lab5
{
    internal class Exam : Grade
    {
        ...
        public string ExamName { get { return examName; } set { examName = value; } }
        ...
        {
            Console.Write("{0}\t{1}\t{2}\t{3}\t{4}\t{5}\t{6}\n", base.name, base.surname, base.grade, this.examName, this.examDuration, this.examDifficulty, base.date);
        }
    }
}
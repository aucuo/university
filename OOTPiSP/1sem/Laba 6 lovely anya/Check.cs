...
namespace PaymentJournal
{
    internal class Check
    {
        ...
        public static MyArray<Expense> ExpenseTemplate(MyArray<Expense> expenseTemplate)
        {
            Console.Clear();
        ...
        public static MyArray<Income> IncomeTemplate(MyArray<Income> incomeTemplate)
        {
            Console.Clear();

...
namespace PaymentJournal
{
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            Blueprint<int> intTemplate = new Blueprint<int>(10);
            Blueprint<char> charTemplate = new Blueprint<char>(10);
            Blueprint<Income> incomeTemplate = new Blueprint<Income>(10);
            Blueprint<Expense> expenseTemplate = new Blueprint<Expense>(10);
            ...
            while (n != 0)
            {
                ...
                {
                    Console.WriteLine($"Exeption was thrown: {error.Message}");
                }
            }
        }
    }

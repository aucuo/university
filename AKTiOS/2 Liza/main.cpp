...
int main()
{
    cout << "1. Dec to BinaryDec: " << DecToBinaryDec("10") << endl; // Десятичное число в Двоично-десятичное

    cout << "2. BinaryDec to Dec: " << BinaryDecToDec("00010000") << endl; // Двоично-десятичное число в десятичное

    cout << "3. ASCII Encrypt: " << CryptText("abcdefg1234567890!@#$%^&*)(;.,") << endl; // Закодировать текст по ASCII

    cout << "4. ASCII Decrypt: " << DecryptText("61 62 63 64 65 66 67 31 32 33 34 35 36 37 38 39 30 21 40 23 24 25 5E 26 2A 29 28 3B 2E 2C") << endl; // Декодировать текст по ASCII

    cout << "5.1. Direct code: " << ToDirectCode("7") << endl;          // Прямой код
    cout << "5.2. Reverse code: " << ToReverseCode("-3") << endl;       // Обратный код
    cout << "5.3. Additional code: " << ToAdditionalCode("-3") << endl; // Дополнительный код

    cout << "6.1. Reverse Sum: " << ReverseSum("-34", "-15") << endl;   // Сложение чисел в обратных кодах
    cout << "6.2. Additional Sum: " << AdditionalSum("1", "2") << endl; // Сложение чисел в дополнительных кодах

    cout << "7. Normalized format: " << ToNormalizedNumber("5,7") << endl; // Представить числа в нормализованном виде

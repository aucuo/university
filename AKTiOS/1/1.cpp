...
int main()
{
    ...
    dectooc(336);
    dectohex(336);
    floatdectobin(712.375);
    floatdectooct(712.375);
    floatdectohex(712.375);

    cout << "\n\nTask 2:\n";
    cout << bintodec(1100010);
    cout << endl;
    bintodec_f(1010100010.001);

    cout << "\n\nTask 3:\n";
    binsum(10111110, 100011100);
    octsum(666.2, 1234.24);

    cout << "\n\nTask 4:\n";
    binsub(1010001111, 1001001110);
    octsub(1437.24, 473.4);

    cout << "\nTask 5:\n";
    binmult(101011, 100111);
    octmult(1732.4, 34.5);
